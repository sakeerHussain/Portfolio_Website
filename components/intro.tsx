    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-24 w-24 rounded-full object-cover border-[0.35rem] border-white shadow-xl transition-all duration-300 ease-in-out transform hover:scale-125"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="/Sakeer-Resume_fullstack.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/sakeer-hussain-b8b12b280/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
